...
from .microduck_velocity_specialist_env_cfg import (
    make_microduck_velocity_specialist_env_cfg,
    MicroduckSpecialistRlCfg,
)

register_mjlab_task(
    task_id="Mjlab-Velocity-Specialist-Flat-MicroDuck",
    env_cfg=make_microduck_velocity_specialist_env_cfg(),
    play_env_cfg=make_microduck_velocity_specialist_env_cfg(play=True),
    rl_cfg=MicroduckSpecialistRlCfg,
